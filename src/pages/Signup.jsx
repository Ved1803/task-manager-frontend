      ...
      <div className="login-card premium-card">
        ...
        <div className="login-form-col premium-form-col">
          <div className="glass-card">
            ...
            <div className="login-subtext">Create your account to get started</div>
            <Formik
            ...
            >
              <Form className="login-form">
                <div className="input-group">
                  ...
                  <Field type="email" name="email" placeholder="Email" className="input-field" autoComplete="username" />
                </div>
                ...
                <div className="input-group">
                  ...
                  <Field type="password" name="password" placeholder="Password" className="input-field" autoComplete="new-password" />
                </div>
                <ErrorMessage name="password" component="div" className="input-error" />
                <div className="input-group">
                  <span className="input-icon">
                    {/* Confirm Password SVG icon */}
                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="10" rx="2" stroke="#888" strokeWidth="2"/><path stroke="#888" strokeWidth="2" d="M7 11V7a5 5 0 0110 0v4"/><path stroke="#888" strokeWidth="2" d="M12 17l2-2-2-2-2 2 2 2z"/></svg>
                  </span>
                  <Field type="password" name="password_confirmation" placeholder="Confirm Password" className="input-field" autoComplete="new-password" />
                </div>
                <ErrorMessage name="password_confirmation" component="div" className="input-error" />
            ...
            <div className="login-footer premium-footer">
              ...
              <div className="social-login-row">
                <a href="#" className="social-btn google" title="Sign up with Google">
                  {/* Google SVG */}
                ...
                <a href="#" className="social-btn facebook" title="Sign up with Facebook">
                  {/* Facebook SVG */}
                ...
                <a href="#" className="social-btn twitter" title="Sign up with Twitter">
                  {/* Twitter SVG */}
